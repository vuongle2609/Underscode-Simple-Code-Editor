<template>
  <div class="flex flex-col items-center justify-center w-screen h-screen gap-6 p-5 bg-bgSecondary">
    <img src="@/assets/image/iconLarge.png" alt="App Icon" class="max-w-[30%]">
